 ...
 * 
 * @KafkaListener(topics = "my-topic", groupId = "my-new-group-1") public void
 * listen1(String message) { System.out.println("Received Message 1: " +
 * message); }
 * 
 * @KafkaListener(topics = "my-topic", groupId = "my-new-group-2") public void
 * listen2(String message) { System.out.println("Received Message 2: " +
 * message); }
 * 
